const LOGO_TYPE = `    __  __           __      ______                 
   / / / /___ ______/ /__   /_  __/___              
  / /_/ / __ \`/ ___/ //_/    / / / __ \\             
 / __  / /_/ / /__/ ,<      / / / /_/ /             
/_/_/_/\\__,_/\\___/_/|_|____/_/  \\____/              
 /_  __/ /_  ___     / ____/_  __/ /___  __________ 
  / / / __ \\/ _ \\   / /_  / / / / __/ / / / ___/ _ \\
 / / / / / /  __/  / __/ / /_/ / /_/ /_/ / /  /  __/
...
extend = (term) => {
  ...
  term.printLogoType = () => {
    term.writeln(term.cols >= 40 ? LOGO_TYPE : "[HackSpace]\r\n");
  };
  ...
  term.init = (user = "hacker", preserveHistory = false) => {
    fitAddon.fit();
    term.reset();
    term.printLogoType();
    term.stylePrint(
